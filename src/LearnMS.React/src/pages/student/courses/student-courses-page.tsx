      ...
      case "NotEnrolled": {
        ...
        return (
          <Button
            onClick={handleEnrollClick}
            disabled={buyCourseMutation.isPending}
            className="flex items-center justify-center w-full gap-2 px-4 py-2 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg hover:bg-blue-700"
          >
            {buyCourseMutation.isPending ? (
              <Loader2 className="w-4 h-4 animate-spin" />
            ) : (
