...
const memories = [
  {
    id: "1",
    src: "https://i.ibb.co/tP4CqBCf/image.png",
    title: "Sandra Samir Soliman",
    description:
      "60/60 in Chemistry General Degree 97.81%  .",
  },
  {
    id: "2",
    src: "https://i.ibb.co/Lbz7G3M/image.png",
    title: "Juneer Jan",
    description:
      "60/60 in Chemistry General Degree 93.13%  ",
  },
  {
    id: "3",
    src: "https://i.ibb.co/k6mPWyw6/image.png",
    title: "Youssab Emad",
    description: "58/60 in Chemistry General Degree 93.59%  ",
  },
  {
    id: "4",
    src: "https://i.ibb.co/5g0vYq9h/image.png",
    title: "Rashi Elijah",
    description:
      "55/60 in Chemistry General Degree 89.6%  ",
  },
  {
    id: "5",
    src: "https://i.ibb.co/gLLjFW9C/image.png",
    title: "Eriny Adel",
    description:
      "54/60 in Chemistry General Degree 95.31%  ",
  },
];
