...
public static class ProfileErrors
{
    ...
    public static readonly ApiError InsufficientCredits = new("profile/insufficient-credits", "Insufficient balance please contact 0122 238 8569", StatusCodes.Status400BadRequest);
